...
class _AddRecipePageState extends State<AddRecipePage> {
  ...
  void initState() {
    ...
    viewModel.addListener(_handleStateChange);
  }
  ...
  @override
  void dispose() {
    viewModel.removeListener(_handleStateChange);
    viewModel.dispose();
    super.dispose();
  }
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(_categories.length, (index) {
                final isSelected = state.selectedCategory == index;
                return GestureDetector(
          ...
          Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 2),
                    Text(
                      'Simpan resep ini ke daftar akses cepat',
              ...
              Switch(
                ...
                onChanged: viewModel.toggleFavorite,
                activeColor: _teal,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Tambahkan dan atur sesuai takaran (gram)',
            style: TextStyle(fontSize: 11, color: Color(0xFF999999)),
          ),
          const SizedBox(height: 16),
          ...
          ] else if (state.allIngredients.isEmpty) ...[
            Padding(
              padding: const EdgeInsets.only(bottom: 12),
              child: Text(
                state.searchQuery.isNotEmpty
                    ? 'Tidak ada bahan yang cocok dengan "${state.searchQuery}"'
          ...
          ...List.generate(state.allIngredients.length, (index) {
            return _buildBahanItem(state.allIngredients[index], index, state);
          }),
          ...
          // Tambah Bahan button
          GestureDetector(
            onTap: state.isLoadingIngredients
                ? null
                : () {
                    // For now, just add a sample ingredient
                    // In a real app, this would open a selection dialog
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: state.isLoadingIngredients
  ...
  Widget _buildBahanItem(
    ...
    return GestureDetector(
      onTap: () {
        viewModel.toggleIngredientInRecipe(bahan);
      },
      child: Container(
        margin: const EdgeInsets.only(bottom: 10),
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
        decoration: BoxDecoration(
          color: isInRecipe ? _teal.withOpacity(0.1) : const Color(0xFFF8F9FA),
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              height: 24,
              decoration: BoxDecoration(
                color: isInRecipe ? _teal : Colors.transparent,
                shape: BoxShape.circle,
                border: Border.all(
                  color: isInRecipe ? _teal : const Color(0xFFE0E0E0),
                  width: 2,
                ),
              ),
              child: isInRecipe
      ...
      child: SizedBox(
        ...
        child: GestureDetector(
          onTap: () async {
            ...
            final success = viewModel.value.success;
