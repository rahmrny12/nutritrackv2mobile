...
class HeartScreeningPage extends StatefulWidget {
  const HeartScreeningPage({super.key});

  @override
  State<HeartScreeningPage> createState() => _HeartScreeningPageState();
}

class _HeartScreeningPageState extends State<HeartScreeningPage> {
