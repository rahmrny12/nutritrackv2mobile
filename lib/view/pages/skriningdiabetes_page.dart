...
class SkriningDiabetesPage extends StatefulWidget {
  const SkriningDiabetesPage({super.key});

  @override
  State<SkriningDiabetesPage> createState() => _SkriningDiabetesPageState();
}

class _SkriningDiabetesPageState extends State<SkriningDiabetesPage> {
  ...
  void _onHitungRisiko() {
    ...
    showModalBottomSheet(
      ...
      onNext: () => Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const SkriningAsamUratPage()),
      ),
    ),
    );
  }
